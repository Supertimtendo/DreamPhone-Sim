...
recreations = ['baseball', 'skateboarding', 'volleyball', 'surfing', 'basketball',
               'tennis', 'ice_cream', 'cookies', 'hot_dogs', 'pizza', 'candy', 'popcorn', 'hat', 'tie', 'blue_jeans',
               'jacket', 'glasses', 'anything_yellow']
...
def assign_clues(crush_num):
    ...
    if crush_num in crosstown_mall:
        clue_flag[0] = 1
    else:
        clue_flag[0] = 0
    if crush_num in snack_shop:
        clue_flag[1] = 1
    else:
        clue_flag[1] = 0
    if crush_num in reel_movies:
        clue_flag[2] = 1
    else:
        clue_flag[2] = 0
    if crush_num in woodland_park:
        clue_flag[3] = 1
    else:
        clue_flag[3] = 0
    if crush_num in high_tide_beach:
        clue_flag[4] = 1
    else:
        clue_flag[4] = 0
    if crush_num in jims_gym:
        clue_flag[5] = 1
    else:
        clue_flag[5] = 0
    if crush_num in baseball:
        clue_flag[6] = 1
    else:
        clue_flag[6] = 0
    if crush_num in skateboarding:
        clue_flag[7] = 1
    else:
        clue_flag[7] = 0
    if crush_num in volleyball:
        clue_flag[8] = 1
    else:
        clue_flag[8] = 0
    if crush_num in surfing:
        clue_flag[9] = 1
    else:
        clue_flag[9] = 0
    if crush_num in basketball:
        clue_flag[10] = 1
    else:
        clue_flag[10] = 0
    if crush_num in tennis:
        clue_flag[11] = 1
    else:
        clue_flag[11] = 0
    if crush_num in ice_cream:
        clue_flag[12] = 1
    else:
        clue_flag[12] = 0
    if crush_num in cookies:
        clue_flag[13] = 1
    else:
        clue_flag[13] = 0
    if crush_num in hot_dogs:
        clue_flag[14] = 1
    else:
        clue_flag[14] = 0
    if crush_num in pizza:
        clue_flag[15] = 1
    else:
        clue_flag[15] = 0
    if crush_num in popcorn:
        clue_flag[16] = 1
    else:
        clue_flag[16] = 0
    if crush_num in candy:
        clue_flag[17] = 1
    else:
        clue_flag[17] = 0
    if crush_num in hat:
    ...
    if crush_num in tie:
        ...
        clue_flag[19] = 0
    if crush_num in blue_jeans:
        clue_flag[20] = 1
    else:
        clue_flag[20] = 0
    if crush_num in jacket:
        clue_flag[21] = 1
    else:
        clue_flag[21] = 0
    if crush_num in glasses:
        clue_flag[22] = 1
    else:
        clue_flag[22] = 0
    if crush_num in anything_yellow:
        clue_flag[23] = 1
    else:
        clue_flag[23] = 0
...
def print_boylist():
    print(os.linesep)
    print(
        "Written inside your trapper keeper is a serial-killer level of details of every potential mate in your school. You turn to the phone numbers page.")
    print(os.linesep)
    for x in range(0, 24):
